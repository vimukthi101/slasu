                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form role="form" action="exportToPdf-allAthlete.php" method="POST">
                                <div class="row">    
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">               
                                ...
                                <div class="row">    
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="athleteCode">
                                                <label class="form-check-label" for="clubCode">Athlete Code</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="athleteName">
                                                <label class="form-check-label" for="clubCode">Athlete Name</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="address">
                                                <label class="form-check-label" for="clubCode">Address</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="phone1">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="phone2">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="whatsapp">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="email">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="nameForCert">
                                                <label class="form-check-label" for="clubCode">Name For Certificate</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="postalId">
                                                <label class="form-check-label" for="clubCode">Postal ID</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="bbNo">
                                                <label class="form-check-label" for="clubCode">Birth Certificate No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="bbDistrict">
                                                <label class="form-check-label" for="clubCode">Birth Certificate District</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="bbDate">
                                                <label class="form-check-label" for="clubCode">Birth Certificate Issue Date</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="bbPhoto">
                                                <label class="form-check-label" for="clubCode">Birth Certificate Photo</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">

                            ...
                            <form role="form" action="exportToPdf-allCoach.php" method="POST">
                                ...
                                <div class="row">    
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachCode">
                                                <label class="form-check-label" for="clubCode">Coach Code</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                ...
                                                <label class="form-check-label" for="clubCode">Club ID</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachName">
                                                <label class="form-check-label" for="clubCode">Coach Name</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="gender">
                                                <label class="form-check-label" for="clubCode">Gender</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachMobileOne">
                                                <label class="form-check-label" for="clubCode">Primary Contact No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachMobileTwo">
                                                <label class="form-check-label" for="clubCode">Secondary Contact No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachWhatsapp">
                                                <label class="form-check-label" for="clubCode">WhatsApp</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachEmail">
                                                <label class="form-check-label" for="clubCode">Email</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="coachNameForId">
                                                <label class="form-check-label" for="clubCode">Name For ID</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="photoForId">
                                                <label class="form-check-label" for="clubCode">Photo for ID</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="application">
                                                <label class="form-check-label" for="clubCode">Application</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">    
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="dob">
                                                <label class="form-check-label" for="clubCode">Date of Birth</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="homeAddress">
                                                <label class="form-check-label" for="clubCode">Home Address</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="designation">
                                                <label class="form-check-label" for="clubCode">Designation</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="nic">
                                                <label class="form-check-label" for="clubCode">NIC</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="nicPhoto">
                                                <label class="form-check-label" for="clubCode">NIC Photo</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="qualifications">
                                                <label class="form-check-label" for="clubCode">Qualifications</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="card">
                                            <div class="card-body">               
                                                <input type="checkbox" class="form-check-input" name="fieldList[]" value="adminRemarks">
                                                <label class="form-check-label" for="clubCode">Admin Remarks</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">

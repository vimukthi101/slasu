    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="mdi mdi-arrow-right-bold" aria-current="page"><a href="admin.php">Admins</a></li>
                                    <li class="mdi mdi-arrow-right-bold" aria-current="page">Create</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <!-- column -->
                    <form role="form" action="adminCreate.php" method="POST" class="contact-one__form" enctype="multipart/form-data">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
		                        ...
		                        <?php
		                         echo '<div class="form-group col-md-12">
		                         		...
		                         		<div class="form-group col-md-5">
		                                    ...
		                                    <div class="">
		                                        <input type="text" class="form-control form-control-line" name="firstName" id="firstName" required pattern="^[a-zA-Z]+(([\',. -][a-zA-Z ])?[a-zA-Z]*)*$" title="Only Letters">
		                                    </div>
		                                </div>
		                                <div class="form-group col-md-5">
		                                    <label class="">Second Name</label>
		                                    <div class="">
		                                        <input type="text" class="form-control form-control-line" name="secondName" id="secondName" pattern="^[a-zA-Z]+(([\',. -][a-zA-Z ])?[a-zA-Z]*)*$" title="Only Letters">
		                                    </div>
		                                </div>
                                        <div class="form-group col-md-5">
                                            <label class="">User Name</label>
                                            <div class="">
                                                <input type="text" class="form-control form-control-line" name="uName" id="uName" pattern="^[a-zA-Z]+(([\',. -][a-zA-Z ])?[a-zA-Z]*)*$" title="Only Letters" required>
                                            </div>
                                        </div>
		                                <div class="form-group col-md-5">
		                                    <label class="">Contact Number</label>
		                                    <div class="">
		                                        <input type="tel" class="form-control form-control-line" maxlength="10" name="mobile" id="mobile">
		                                    </div>
		                                </div>
		                                <div class="form-group col-md-5">
		                                    <label class="">Email</label>
		                                    <div class="">
		                                        <input type="text" class="form-control form-control-line" name="email" id="email" required>
		                                    </div>
		                                </div>
		                                <div class="form-group col-md-5">
		                                    <label class="">NIC</label>
		                                    <div class="">
		                                        <input type="text" class="form-control form-control-line" name="nic" id="nic" pattern="^(?:19|20)?\d{2}[0-9]{10}|[0-9]{9}[x|X|v|V]$" title="Should match NIC format" required>
		                                    </div>
		                                </div>
                    <div class="col-lg-12"><hr/></div>
                                    <input type="submit" name="submit" value="Create" id="submit" class="btn btn-success" style="margin: auto;"></input>
                                </div><!-- /.col-md-12 -->
		                                ';
		                        ?>
                        	</div>	

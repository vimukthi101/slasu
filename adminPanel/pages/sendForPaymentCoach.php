...
<body>
    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            <form role="form" action="sendForPaymentCoachController.php" method="POST">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="card">
                                        <div class="card-body">                                                
                                            <label class="">Coaches List</label>
                                            <div>
                                            <?php
                                                if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])){
                                                    if(!empty($_POST['editAthlete'])) {
                                                        ...
                                                        $totalAmout = 2500 * count($array);
                                                        for($i=0;$i<count($array);$i++){
                                                            echo '<label class="">SLASU/C/00'.$array[$i].'</label><br/>';
                                                        }
                                                    } else {

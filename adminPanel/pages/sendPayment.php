                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <?php
                                                    $query = 'SELECT affiliationFeeStatus,enrollmentFeeStatus,affiliationCat,regType FROM `club` WHERE clubId='.$_SESSION["clubId"];
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-5">
                                    <div class="card">
                                        <div class="card-body">      
                                        <h4 class="card-title">Select Athletes</h4>                                          
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-5">
                                    <div class="card">
                                        <div class="card-body">         
                                        <h4 class="card-title">Select Coaches</h4>                                             
                                            <label class="" for="inputGroupSelect01">Aquatic Category</label>
                                            <select class="custom-select form-control" name="multi_search_filter_2" id="multi_search_filter_2">
                                                <option selected disabled>Select Type...</option>
                                                <option value="1">Swimming</option>
                                                <option value="2">Artistic Swimming</option>
                                                <option value="3">Water Polo</option>
                                            ...
                                            <input type="hidden" name="hidden_country_2" id="hidden_country_2" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody class="result" id="coachBody" name="coachBody">
                                    </tbody>
                                </table>
                            </div>
                        </div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"fetchPaymentAthlete.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
    $('#athleteBody').html(data);
   }
  })
 }
...
$(document).ready(function(){
 ...
 $('#multi_search_filter_2').change(function(){
  $('#hidden_country_2').val($('#multi_search_filter_2').val());
  var query = $('#hidden_country_2').val();
  load_data(query);
 });
...
<script type="text/javascript">
function toggleCoach(source) {
    checkboxes = document.getElementsByName('editCoach[]');
    for(var i=0, n=checkboxes.length;i<n;i++) {
        checkboxes[i].checked = source.checked;
    }
}

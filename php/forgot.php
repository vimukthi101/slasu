    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <h2 class="page-header__title">Forgot Password</h2><!-- /.page-header__title -->
            </div><!-- /.container -->
        </section><!-- /.page-header -->
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__image wow fadeInRight" data-wow-duration="1500ms">
                            <div class="contact-one__content">
                                ...
                                <p><a href="forgot.php">Reset From Here</a></p><br/>
                                    ...
                                    if(isset($_GET['er'])){
                                        if(!empty($_GET['er'])){
                                            ...
                                            if($error == "em"){
                                                ...
                                                echo '<div class="col-md-12">
                                                    <span style="color:red;">No User found for given Username.</span>
                                                </div>';
                                            }  else if ($error == "mf"){
                                                echo '<div class="col-md-12">
                                                    <span style="color:green;">Couldn\'t send the email. Please contact admin.</span>
                                                </div>';
                                            }  else if ($error == "qf"){
                                                echo '<div class="col-md-12">
                                                    <span style="color:red;">Couldn\'t reset, Please try again later.</span>
                                                </div>';
                                            }
                                        }   
                                    }
                                ?>
                        <form action="reset.php" role="form" method="post" class="contact-one__form contact-form-validated">
                            <div class="row" class="thm-btn contact-one__btn">
                                <div class="col-md-12">
                                    <input type="tel" maxlength="10" placeholder="User Name" name="username" id="username" required> 
                                </div><!-- /.col-md-6 -->

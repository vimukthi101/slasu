                    ...
                    <div class="col-xl-12">
                        <form role="form" action="php/club-registration-confirm.php" method="POST" class="" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12"><hr/></div>
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="Operator's Name *" name="operatorName" id="operatorName" required pattern="^[a-zA-Z ,.'-]*$" title="Only Letters">
                                </div><!-- /.col-md-12 -->
                                <div class="col-md-6">
                        ...
                        <div class="col-lg-12"><hr/></div>
                            ...
                            <div class="col-lg-12"><hr/></div>
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="Name *" name="inchargeName" required pattern="^[a-zA-Z ,.'-]*$" title="Only Letters">
                                </div><!-- /.col-md-12 -->
                                <div class="col-md-6">

    ...
    <body>
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <h2 class="page-header__title">Registered Clubs List</h2><!-- /.page-header__title -->
            </div><!-- /.container -->
        </section><!-- /.page-header -->

        <section class="gallery-one">
            <div class="container">
                <h2><?php echo date("Y");?>  Registered Clubs</h2>
                <div class="row">
                    <table class="table">
                        <thead>
                            <tr>
